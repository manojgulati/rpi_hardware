...
static int imx219_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_TEST_PATTERN_RED:
        if(((ctrl->val)&0xf)==10){
            x_inc=0;
            y_inc=0;
	        imx219_write_reg(imx219, 0x0174,IMX219_REG_VALUE_08BIT,((ctrl->val)>>4));
	        imx219_write_reg(imx219, 0x0175,IMX219_REG_VALUE_08BIT,((ctrl->val)>>4));
	        imx219_write_reg(imx219, 0x0164,IMX219_REG_VALUE_16BIT,0+x_inc);
	        imx219_write_reg(imx219, 0x0166,IMX219_REG_VALUE_16BIT,0x4af+x_inc);
	        imx219_write_reg(imx219, 0x0168,IMX219_REG_VALUE_16BIT,0+y_inc);
	        imx219_write_reg(imx219, 0x016a,IMX219_REG_VALUE_16BIT,0x31f+y_inc);
        }
        if(((ctrl->val)&0xf)==11){
            x_inc=1200;
            y_inc=0;
